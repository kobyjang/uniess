            ...
            <div>
                <c:if test="${message eq null }">
                    <div>
                        <table border="1">
                            <tr>
                                <td width="100" align="center">축제번호</td>
                                <td width="100" align="center">${board.content_id }</td>
                                <td width="100" align="center">이름</td>
                                <td width="150" align="center">${board.title }</td>
                                <td width="100" align="center">작성일자</td>
                                <td width="300" align="center">${board.event_start_date } ~ ${board.event_end_date } </td>
                                <td width="100" align="center">주소</td>
                                <td width="150" align="center">${board.addr }</td>
                            ...
                            <tr>
                                ...
                                <td colspan="6">${board.oview }<br>${board.homepage }</td>
                            </tr>
