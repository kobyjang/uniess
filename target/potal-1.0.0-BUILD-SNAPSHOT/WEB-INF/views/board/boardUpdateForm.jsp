                    ...
                    <form id="frm" action="boardUpdate.do" method="post">
                        ...
                        <div>
                            <table border="1">
                                <tr>
                                    <th width="100">제 목</th>
                                    <td width="250"><input type="text" id="title" name="title"
                                            value="${board.title }" size="30" placeholder="제목을 입력하세요..."
                                ...
                                <tr>
                                    <th>내 용</th>
                                    <td colspan="4">
                                        <textarea rows="10" cols="90" id="subject" name="subject"
                                            style="border: none">${board.subject }</textarea>
                                    </td>
                                </tr>
                            </table>
                        </div><br>
                        <div>
                            <button type="submit"
                                class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">글수정</button>&nbsp;&nbsp;
                            <button type="button"
