                    ...
                    <div>
                        <table border="1">
                            ...
                            <tr>
                                <th>내 용</th>
                                <td colspan="5">
                                    <textarea style="border: none" readonly rows="10"
                                        cols="80">${board.subject}</textarea>
                                </td>
                            </tr>
                        </table>
                    </div><br>
                    <div>
                        ...
                        <c:if test="${author eq 'ADMIN' || id eq board.writer}">
                            <c:if test="${id eq board.writer}">
                                <button type="button"
                                    class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn"
                                    onclick="updateFuntion(${board.no})">글 수정</button>&nbsp;&nbsp;
                            </c:if>
                            <button type="button"
                                class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn"
                                onclick="deleteFuntion(${board.no})">글 삭제</button>
                        </c:if>
                    </div>
                </c:if>
